			...
			<div id="fullpage">
				...
				<section class="section fp-auto-height">
					<section class="cp-marketing-section referral-section-2">
						<h2 class="cp-marketing-title r-a-s-title"><?php echo CFS()->get( 'referral_message' ); ?></h2>
					</section>
					...
					<section class="referral-section-4">
						<h2 class="cp-orange-section"><?php echo CFS()->get( 'similar_project' ); ?></h2>
					</section>
					...
					<section class=" referral-section-5 section-above-footer">
						...
						<a class="cp-button-link fp-scroller" href="http://localhost:3000/cinderella">Find Results</a>
					</section>
					<?php get_footer(); ?>
