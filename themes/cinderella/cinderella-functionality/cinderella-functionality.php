<?php
 /**
 *
 * @package   The Cinderella Project Functionality
 * @author    Ermilson Jordan, Scott Fuoco, Sharifa Samuels
 * @license   GPL-2.0+
 * @copyright 2016 Fairygodmothers Inc.
 *
 * @wordpress-plugin
 * Plugin Name: The Cinderella Project Functionality
